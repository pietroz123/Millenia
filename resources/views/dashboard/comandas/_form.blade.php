        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <select class="browser-default custom-select" id="cliente" name="cliente" required {{ ($comanda->aberta !== null and $comanda->aberta == false) ? 'disabled' : '' }}>
                        <option></option>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <select class="browser-default custom-select" id="servicos" name="servicos[]" multiple="multiple" {{ ($comanda->aberta !== null and $comanda->aberta == false) ? 'disabled' : '' }}>
